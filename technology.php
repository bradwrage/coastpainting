...
<section class="main-section">
	<div class="row">
    <div class="large-12 columns">
      <h2 class="section-header">Optogenetics</h2>
      <h5 class="section-subheader">Circuit Therapeutics is the industry leader in optogenetics and is pioneering new treatments through the use of this groundbreaking technology.  Optogenetics has gained rapid acceptance globally and is being used by hundreds of laboratories worldwide</h3>
    </div>
  </div>
...
<section class="main-section">
	<div class="row">
    <div class="large-12 columns">
      <h2 class="section-header">Opsins</h2>
      <h5 class="section-subheader">Opsin diversity and targeted cell-type specificity allow for the activation or inhibiting of nuerons using a range of light paradigms, as well as the ability to manipulate multiple cell-types simultaneously, makes optogenetics a unique and powerful tool for neuromodulation.</h3>
    </div>
  </div>
